...
| **Summary title** | `MQTT data with GPIO-LED, global batching/retention, and management events` |
...
| **Summary title** | `Tag events over AWS IoT Core` |
...
| **Summary title** | `Tag events over Azure IoT Hub` |
