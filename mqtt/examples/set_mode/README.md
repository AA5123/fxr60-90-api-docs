...
|---|---|---|---|---|
| `request/SIMPLE.json` | request | `SIMPLE` | `cloud-mode/PUT/SIMPLE.json` | SIMPLE mode baseline |
| `request/INVENTORY.json` | request | `INVENTORY` | `cloud-mode/PUT/INVENTORY.json` | INVENTORY mode with report interval |
| `request/PORTAL.json` | request | `PORTAL` | `cloud-mode/PUT/PORTAL.json` | PORTAL mode with GPI start trigger |
| `request/CONVEYOR.json` | request | `CONVEYOR` | `cloud-mode/PUT/CONVEYOR.json` | CONVEYOR mode baseline |
| `request/CUSTOM_filter.json` | request | `CUSTOM_filter` | `cloud-mode/PUT/CUSTOM_filter.json` | CUSTOM filter |
