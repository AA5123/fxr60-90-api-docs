...
### `request/Network_ethernet_static.json`
...
### `request/Network_ethernet_static_8021x_tls.json`
...
### `request/Network_ethernet_dhcp_8021x_tls.json`
...
### `request/Network_ethernet_dhcp_8021x_ttls_mschapv2.json`
...
### `request/Network_wifi_security_wpa2_personal.json`
...
### `request/Network_wifi_wpa3_enterprise_ttls_mschapv2.json`
...
### `request/Network_wifi_wpa2_enterprise_ttls_tls.json`
...
### `request/Network_wifi_wpa3_enterprise_peap_mschapv2.json`
...
| **Summary title** | `Command succeeded` |
