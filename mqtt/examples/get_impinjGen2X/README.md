...
GET returns the last saved feature only. Never-configured returns an empty HTTP body, not `{}`.

| File | Direction | Example | REST source | Summary |
|---|---|---|---|---|
| `request/default.json` | request | `default` | `—` | Empty get_impinjGen2X request |
| `response/fastID_disabled.json` | response | `fastID_disabled` | `cloud-impinjgen2x/GET/fastID_disabled.json` | FXR60 and FXR90 5.0.7 |
